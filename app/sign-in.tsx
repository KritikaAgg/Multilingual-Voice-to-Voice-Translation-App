      ...
      <ScrollView contentContainerClassName='h-full'>
        ...
        <View className='px-10'>
          ...
          <Text className='text-lg font-rubik text-black-200 text-center mt-10'>
            Login to Translator with Google
          </Text>
          
          <TouchableOpacity onPress={handleLogin} className='bg-white
          shadow-md shadow-black-300 rounded-full w-full py-4 mt-5'>
